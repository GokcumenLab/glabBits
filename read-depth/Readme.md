...
2) If such a BED file is not present, the script uses the input BAM file to create a BED file which contain the start and end positions of each read. Let us call this reads-BED file
